    ...
    <nav class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <c:if test="${sessionScope.role == 'MANAGER'}">
                ...
                <li><a href="${pageContext.request.contextPath}/categories" id="nav-categories"><i class="fas fa-tags"></i> Categories</a></li>
            ...
            <li><a href="${pageContext.request.contextPath}/profile" id="nav-profile"><i class="fas fa-user-cog"></i> Profile</a></li>
