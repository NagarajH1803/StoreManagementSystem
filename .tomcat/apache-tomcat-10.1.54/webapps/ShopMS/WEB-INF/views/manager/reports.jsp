        ...
        .then(data => {
            ...
            reportChart = new Chart(document.getElementById('reportChart'), {
                ...
                data: {
                    labels: labels,
                    datasets: [
                        { label: 'Sales (Rs.)', data: totals, backgroundColor: 'rgba(99,102,241,0.8)', borderRadius: 6 },
                        { label: 'Orders', data: counts, backgroundColor: 'rgba(14,165,233,0.8)', borderRadius: 6 }
                    ]
                },
